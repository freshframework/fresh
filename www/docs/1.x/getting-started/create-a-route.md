...
> [info]: To learn more about JSX, you can read [this article][jsx] in the React documentation. Beware that Fresh does not use React, but rather [Preact][preact], a lighter weight virtual dom library that works similar to React.
