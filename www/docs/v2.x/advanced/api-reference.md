...
> [info]: You can also explore Fresh's full API documentation on JSR: [`@fresh/core`](https://jsr.io/@fresh/core/doc)
...
Shared runtime utilities for both server and client code. Safe to import in [islands](/docs/concepts/islands).
