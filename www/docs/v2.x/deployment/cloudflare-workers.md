...
2. Add the cloudflare plugin in your [vite](/docs/advanced/vite) configuration file:
...
Check out the [Cloudflare Documentation](https://developers.cloudflare.com/workers/vite-plugin/) for further information.
